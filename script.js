  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (isValid) {
        ...
        // Simulate submission - replace with actual fetch if needed
        setTimeout(() => {
          contactForm.reset();
          if (submitBtn) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '225cc5ca-230f-4d24-99c5-6192daa031aa',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '225cc5ca-230f-4d24-99c5-6192daa031aa';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '77983a26-f516-4126-80d5-a4b18e4b108e';
